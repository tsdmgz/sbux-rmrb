...
In China, tea is still the dominant beverage of choice
\autocite{that_euromonitor_thing}. The same holds true in a large part of the
world, and will be so for a good period of time. In places where coffee holds
dominance, it serves the same purpose as tea would: for keeping one awake and as
